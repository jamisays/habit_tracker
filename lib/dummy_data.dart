...
var dummyHabits = [
  GoodHabit(
    ...
    isActive: true, selectedScheduleType: '',
  ),
  GoodHabit(
    id: 'h2',
    category: 'c2',
  ...
  GoodHabit(
    id: 'h9',
    category: 'c3',
    title: 'Get out of bed on first alarm',
    tempSpirit: 0,
    startDate: DateTime.utc(DateTime.now().year, DateTime.now().month, 1),
    duration: 0,
    difficultyLevel: 'Easy',
